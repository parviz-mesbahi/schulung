...
@section('content')
    ...
    <form action="{{ isset($lesson) ? route('lessons.update', $lesson) : route('lessons.store') }}" method="POST" >
        ...
        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            ...
            <div>
                <label for="last-name" class="block text-sm/6 font-semibold text-gray-900">Title</label>
                <div class="mt-2.5">
            ...
            <div class="sm:col-span-2">
                <label for="company" class="block text-sm/6 font-semibold text-gray-900">Url Tag</label>
                <div class="mt-2.5">
