        ...
        <figure class="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
            <div class="relative col-span-2 lg:col-start-1 lg:row-start-2">
                ...
                <blockquote class="text-xl/4  text-gray-900 sm:text-2xl/9">
                    ...
                    <p class="mx-auto mt-4 max-w-xl text-lg/8 text-gray-600">Die Zufriedenheit unserer Kursteilnehmer liegt uns besonders am Herzen. Unser Ziel ist es, Ihnen nicht nur Wissen zu vermitteln, sondern auch Ihre Fähigkeiten durch moderne und praxisnahe Ansätze nachhaltig zu verbessern.
...
{{--                    <p class="text-3xl  mb-2 mt-10 text-indigo-600">Kursformat:</p>--}}
                    ...
                    <ul class="list-decimal pl-4 space-y-2">
                        <li class="mx-auto mt-4 max-w-xl text-lg/8 text-gray-600">
