...
<head>
    ...
    <title>Entwicklung | IT-Schulungen: Java, Datenbanken, Algorithmen  & Spring Boot | MaxaBit IT-Solutions Bonn</title>
            ...
            <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:mt-10 lg:max-w-none lg:grid-cols-12">
                ...
                <div class="max-w-xl text-base/7 text-gray-700 lg:col-span-7">
                    <p>
                        ...
                        die optimal auf die Anforderungen und Strukturen der erfassten Daten abgestimmt ist. </br>
