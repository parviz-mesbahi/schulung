                ...
                <div class="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                    ...
                    <figure class="relative isolate">
                        ...
                        <figcaption class="mt-6 text-sm/6 text-gray-300">
                            ...
                            <a href="{{ url('/kurs/java/ueber-kurs') }}" class="inline-block px-6 py-2.5 bg-blue-500
                            text-white font-semibold text-center rounded-lg hover:bg-blue-700 focus:outline-none
                            focus:ring-2 focus:ring-blue-300">
                                Kurs Inhalt
                            </a>
                ...
                <div class="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                    ...
                    <figure class="relative isolate">
                        ...
                        <figcaption class="mt-6 text-sm/6 text-gray-300">
                            ...
                            <a href="{{ url('/kurs/algorithmus/ueber-kurs') }}" class="inline-block px-6 py-2.5 bg-blue-500
                            text-white font-semibold text-center rounded-lg hover:bg-blue-700 focus:outline-none
                            focus:ring-2 focus:ring-blue-300">
                                Kurs Inhalt
                            </a>
                ...
                <div class="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                    ...
                    <figure class="relative isolate">
                        ...
                        <figcaption class="mt-6 text-sm/6 text-gray-300">
                            ...
                            <a href="{{ url('/kurs/datenbank/ueber-kurs') }}" class="inline-block px-6 py-2.5 bg-blue-500
                            text-white font-semibold text-center rounded-lg hover:bg-blue-700 focus:outline-none
                            focus:ring-2 focus:ring-blue-300">
                                Kurs Inhalt
                            </a>
                ...
                <div class="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                    ...
                    <figure class="relative isolate">
                        ...
                        <div class="flex">
                            ...
                            <figcaption class="mt-6 text-sm/6 text-gray-300">
                                <a href="{{ url('/kurs/springboot/ueber_kurs') }}" class="inline-block px-6 py-2.5 bg-blue-500
                                text-white font-semibold text-center rounded-lg hover:bg-blue-700 focus:outline-none
                                focus:ring-2 focus:ring-blue-300">
                                    Kurs Inhalt
                                </a>
