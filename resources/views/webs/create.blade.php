...
@section('content')
    <a href="{{ route('webs.index') }}" class=" rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Back to Web</a>
...
{{--                <div class="mt-2.5">--}}
{{--                    <input type="text" name="description" id="description" autocomplete="description" value="{{ $web->description ?? '' }}" required--}}
{{--                           class="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600">--}}
{{--                </div>--}}
{{--            </div>--}}
            ...
            <div class="sm:col-span-2">
                ...
                <div class="mt-2.5">
                    <textarea name="content" id="content" rows="4" value="{{ $web->content ?? '' }}"
